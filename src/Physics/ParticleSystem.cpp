...
namespace np {
    ...
    void ParticleSystem::AddDuringFixtureParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem *particleSystem, b2ParticleBodyContact *particleBodyContact)){
        this->duringFixtureParticleCollisionBeginActions.push_back(contactAction);
    }
    
    void ParticleSystem::AddDuringFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture *fixture, b2ParticleSystem *particleSystem, int32 particleIndex)){
        this->duringFixtureParticleCollisionEndActions.push_back(contactAction);
    }
    
    void ParticleSystem::AddDuringParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem *particleSystem, b2ParticleContact *particleContact)){
        this->duringParticleCollisionBeginActions.push_back(contactAction);
    }
    
    void ParticleSystem::AddDuringParticleCollisionEndAction(void (*contactAction)(b2ParticleSystem *particleSystem, int32 firstParticleIndex, int32 secondParticleIndex)){
        this->duringParticleCollisionEndActions.push_back(contactAction);
    }
    
    //post collision actions
    
    void ParticleSystem::AddPostFixtureParticleCollisionBeginAction(void (*contactAction)(b2Fixture *fixture, b2ParticleSystem *particleSystem, int32 particleIndex)){
        this->postFixtureParticleCollisionBeginActions.push_back(contactAction);
    }
    
    void ParticleSystem::AddPostFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture *fixture, b2ParticleSystem *particleSystem, int32 particleIndex)){
        this->postFixtureParticleCollisionEndActions.push_back(contactAction);
    }
    
    void ParticleSystem::AddPostParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem *particleSystem, int32 firstParticleIndex, int32 secondParticleIndex)){
        this->postParticleCollisionBeginActions.push_back(contactAction);
    }
    
    void ParticleSystem::AddPostParticleCollisionEndAction(void (*contactAction)(b2ParticleSystem *particleSystem, int32 firstParticleIndex, int32 secondParticleIndex)){
