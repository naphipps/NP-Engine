...
namespace np
{
	...
	void Body::AddDuringFixtureParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																				  b2ParticleBodyContact* particleBodyContact))
	{
		this->duringFixtureParticleCollisionBeginActions.push_back(contactAction);
	}

	void Body::AddDuringFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture* fixture,
	...
	void Body::AddPostFixtureParticleCollisionBeginAction(void (*contactAction)(b2Fixture* fixture,
																				b2ParticleSystem* particleSystem,
																				int32 particleIndex))
	{
	...
	void Body::AddPostFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture* fixture,
																			  b2ParticleSystem* particleSystem,
																			  int32 particleIndex))
	{
	...
	void Body::RemoveDuringFixtureCollisionBeginAction(void (*contactAction)(b2Contact* contact))
	{
		...
		iterator = find(this->duringFixtureCollisionBeginActions.begin(), this->duringFixtureCollisionBeginActions.end(),
						contactAction);
	...
	void Body::RemoveDuringFixtureCollisionEndAction(void (*contactAction)(b2Contact* contact))
	{
		std::vector<void (*)(b2Contact*)>::iterator iterator;
		iterator =
			find(this->duringFixtureCollisionEndActions.begin(), this->duringFixtureCollisionEndActions.end(), contactAction);
	...
	void Body::RemoveDuringFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture* fixture,
																				   b2ParticleSystem* particleSystem,
																				   int32 particleIndex))
	{
	...
	void Body::RemovePostFixtureParticleCollisionBeginAction(void (*contactAction)(b2Fixture* fixture,
																				   b2ParticleSystem* particleSystem,
																				   int32 particleIndex))
	{
		std::vector<void (*)(b2Fixture * fixture, b2ParticleSystem * particleSystem, int32 particleIndex)>::iterator iterator;
	...
	void Body::RemovePostFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture* fixture,
																				 b2ParticleSystem* particleSystem,
																				 int32 particleIndex))
	{
		std::vector<void (*)(b2Fixture * fixture, b2ParticleSystem * particleSystem, int32 particleIndex)>::iterator iterator;
