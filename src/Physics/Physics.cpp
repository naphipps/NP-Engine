...
namespace np
{
	...
	void Physics::SubscribeForDuringFixtureParticleCollisionBeginEvents(Body* body,
	...
	void Physics::SubscribeForDuringFixtureParticleCollisionEndEvents(Body* body,
																	  void (*contactAction)(b2Fixture*, b2ParticleSystem*,
																							int32))
	{
	...
	void Physics::SubscribeForDuringFixtureParticleCollisionBeginEvents(ParticleSystem* particleSystem,
																		void (*contactAction)(b2ParticleSystem*,
																							  b2ParticleBodyContact*))
	{
	...
	void Physics::SubscribeForDuringFixtureParticleCollisionEndEvents(ParticleSystem* particleSystem,
																	  void (*contactAction)(b2Fixture*, b2ParticleSystem*,
																							int32))
	{
	...
	void Physics::SubscribeForDuringParticleCollisionBeginEvents(ParticleSystem* particleSystem,
	...
	void Physics::SubscribeForDuringParticleCollisionEndEvents(ParticleSystem* particleSystem,
	...
	void Physics::SubscribeForPostFixtureParticleCollisionBeginEvents(Body* body,
																	  void (*contactAction)(b2Fixture*, b2ParticleSystem*,
																							int32))
	{
	...
	void Physics::SubscribeForPostFixtureParticleCollisionEndEvents(Body* body,
	...
	void Physics::SubscribeForPostFixtureParticleCollisionBeginEvents(ParticleSystem* particleSystem,
																	  void (*contactAction)(b2Fixture*, b2ParticleSystem*,
																							int32))
	{
	...
	void Physics::SubscribeForPostFixtureParticleCollisionEndEvents(ParticleSystem* particleSystem,
																	void (*contactAction)(b2Fixture*, b2ParticleSystem*, int32))
	{
	...
	void Physics::SubscribeForPostParticleCollisionBeginEvents(ParticleSystem* particleSystem,
															   void (*contactAction)(b2ParticleSystem*, int32, int32))
	{
	...
	void Physics::SubscribeForPostParticleCollisionEndEvents(ParticleSystem* particleSystem,
															 void (*contactAction)(b2ParticleSystem*, int32, int32))
	{
