...
namespace np {
    ...
    public:
        ...
        void SubscribeForDuringFixtureParticleCollisionBeginEvents(Body* body, void (*contactAction)(b2ParticleSystem*, b2ParticleBodyContact*));
        void SubscribeForDuringFixtureParticleCollisionEndEvents(Body* body, void (*contactAction)(b2Fixture*, b2ParticleSystem*, int32));
        
        void SubscribeForDuringFixtureParticleCollisionBeginEvents(ParticleSystem* particleSystem, void (*contactAction)(b2ParticleSystem*, b2ParticleBodyContact*));
        void SubscribeForDuringFixtureParticleCollisionEndEvents(ParticleSystem* particleSystem, void (*contactAction)(b2Fixture*, b2ParticleSystem*, int32));
        void SubscribeForDuringParticleCollisionBeginEvents(ParticleSystem* particleSystem, void (*contactAction)(b2ParticleSystem*, b2ParticleContact*));
        void SubscribeForDuringParticleCollisionEndEvents(ParticleSystem* particleSystem, void (*contactAction)(b2ParticleSystem*, int32, int32));
        ...
        void SubscribeForPostFixtureParticleCollisionBeginEvents(Body* body, void (*contactAction)(b2Fixture*, b2ParticleSystem*, int32));
        void SubscribeForPostFixtureParticleCollisionEndEvents(Body* body, void (*contactAction)(b2Fixture*, b2ParticleSystem*, int32));
        
        void SubscribeForPostFixtureParticleCollisionBeginEvents(ParticleSystem* particleSystem, void (*contactAction)(b2Fixture*, b2ParticleSystem*, int32));
        void SubscribeForPostFixtureParticleCollisionEndEvents(ParticleSystem* particleSystem, void (*contactAction)(b2Fixture*, b2ParticleSystem*, int32));
        void SubscribeForPostParticleCollisionBeginEvents(ParticleSystem* particleSystem, void (*contactAction)(b2ParticleSystem*, int32, int32));
        void SubscribeForPostParticleCollisionEndEvents(ParticleSystem* particleSystem, void (*contactAction)(b2ParticleSystem*, int32, int32));
