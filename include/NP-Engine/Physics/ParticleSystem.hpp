...
namespace np
{
	...
	private:
		...
		void AddDuringFixtureParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																				b2ParticleBodyContact* particleBodyContact));
		void AddDuringFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture* fixture,
																			  b2ParticleSystem* particleSystem,
																			  int32 particleIndex));

		void AddDuringParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																		 b2ParticleContact* particleContact));
		void AddDuringParticleCollisionEndAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																	   int32 firstParticleIndex, int32 secondParticleIndex));

		// post collision actions

		void AddPostFixtureParticleCollisionBeginAction(void (*contactAction)(b2Fixture* fixture,
																			  b2ParticleSystem* particleSystem,
																			  int32 particleIndex));
		void AddPostFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture* fixture,
																			b2ParticleSystem* particleSystem,
																			int32 particleIndex));

		void AddPostParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																	   int32 firstParticleIndex, int32 secondParticleIndex));
		void AddPostParticleCollisionEndAction(void (*contactAction)(b2ParticleSystem* particleSystem, int32 firstParticleIndex,
		...
		void RemoveDuringFixtureParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																				   b2ParticleBodyContact* particleBodyContact));
		void RemoveDuringFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture* fixture,
																				 b2ParticleSystem* particleSystem,
																				 int32 particleIndex));

		void RemoveDuringParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																			b2ParticleContact* particleContact));
		void RemoveDuringParticleCollisionEndAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																		  int32 firstParticleIndex, int32 secondParticleIndex));

		// post collision actions

		void RemovePostFixtureParticleCollisionBeginAction(void (*contactAction)(b2Fixture* fixture,
																				 b2ParticleSystem* particleSystem,
																				 int32 particleIndex));
		void RemovePostFixtureParticleCollisionEndAction(void (*contactAction)(b2Fixture* fixture,
																			   b2ParticleSystem* particleSystem,
																			   int32 particleIndex));

		void RemovePostParticleCollisionBeginAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																		  int32 firstParticleIndex, int32 secondParticleIndex));
		void RemovePostParticleCollisionEndAction(void (*contactAction)(b2ParticleSystem* particleSystem,
																		int32 firstParticleIndex, int32 secondParticleIndex));
