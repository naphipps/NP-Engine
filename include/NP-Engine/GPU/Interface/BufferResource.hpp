...
namespace np::gpu
{
	...
	public:
		...
		constexpr static ui32 Dynamic = BIT(6);
		constexpr static ui32 Indirect = BIT(7);

		constexpr static ui32 Transfer = BIT(8);
		constexpr static ui32 Uniform = BIT(9);
		constexpr static ui32 Storage = BIT(10);
		constexpr static ui32 Texel = BIT(11);
		constexpr static ui32 Index = BIT(12);
		constexpr static ui32 Vertex = BIT(13);
	...
	struct BufferResource : public Resource
	{
		...
		virtual bl SetBytes(siz offset, const con::vector<ui8>& bytes) = 0;

		virtual con::vector<ui8> GetBytes(siz offset, siz size) = 0;
	};
} // namespace np::gpu
