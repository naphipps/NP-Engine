		...
		namespace __detail
		{
			...
			*/
			...
			private:
				...
				NodePtr ParentAndColor =
					nullptr; // we compress our parent and color value since our alignment enables us to do so
			...
			private:
				...
				Node _nil; // TODO: set this up so this isn't needed... it's useless overhead... is it? I think it's fine... --
						   // define convention to mark this as OPTIMIZE instead of TODO...
