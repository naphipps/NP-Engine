...
namespace np
{
	namespace math
	{
		namespace __detail
		{
			 ...
			 */
			static inline bl GetLowSlopedLine(ui16Point line[], ui32& line_size, const ui32 line_max_size, ui16Point begin,
											  ui16Point end)
			{
				ui32 i = 0;
			...
			/**
			 ...
			 inputs include the line array and line size ref for us to set as long as it stays under the given max line size
			 */
			static inline bl GetHighSlopedLine(ui16Point line[], ui32& line_size, const ui32 line_max_size, ui16Point begin,
											   ui16Point end)
			{
				ui32 i = 0;
				bl result = i < line_max_size;
			 ...
			 */
			template <siz ARRAY_SIZE>
			static inline bl GetHighSlopedLine(ui16PointArray<ARRAY_SIZE>& line, ui32& line_size, ui16Point begin,
											   ui16Point end)
			{
				ui32 i = 0;
				bl result = i < line.size();
		...
		/**
		 ...
		 inputs include the line array and line size ref for us to set as long as it stays under the given max line size
		 */
		static inline bl GetBresenhamLinePoints(ui16Point line[], ui32& line_size, const ui32 line_max_size, ui16Point begin,
												ui16Point end)
		{
			bl result = true;
		 ...
		 */
		template <siz ARRAY_SIZE>
		static inline bl GetBresenhamLinePoints(ui16PointArray<ARRAY_SIZE>& line, ui32& line_size, ui16Point begin,
												ui16Point end)
		{
			bl result = true;
