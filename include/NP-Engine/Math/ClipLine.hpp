...
namespace np
{
	namespace math
	{
		// TODO: I think we should create a separate repo to house code like this that have their own citation comments, then we
		// can include them via vendor include
