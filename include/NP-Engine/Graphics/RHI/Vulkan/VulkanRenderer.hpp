...
namespace np::gfx::rhi
{
	...
	public:
		VulkanRenderer(srvc::Services& services):
			...
			_render_pass(nullptr),
			_framebuffers(nullptr),
			_object_vertex_shader_filename(fsys::Append(fsys::Append("Vulkan", "shaders"), "object_vertex.glsl")),
			_object_fragment_shader_filename(fsys::Append(fsys::Append("Vulkan", "shaders"), "object_fragment.glsl")),
			_object_vertex_shader(nullptr),
			_object_fragment_shader(nullptr),
			_object_pipeline(nullptr),
			_light_vertex_shader_filename(fsys::Append(fsys::Append("Vulkan", "shaders"), "light_vertex.glsl")),
			_light_fragment_shader_filename(fsys::Append(fsys::Append("Vulkan", "shaders"), "light_fragment.glsl")),
			_light_vertex_shader(nullptr),
			_light_fragment_shader(nullptr),
			_light_pipeline(nullptr),
