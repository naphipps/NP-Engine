...
namespace np
{
	namespace core
	{
		...
		{
			// TODO: how else would we represent this without punning?? make the i portion a function, since we really only care
			// about the rgba - we could make RgbColor, RgbaColor, HsvColor, etc
